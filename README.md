...
One script which generates fully functional live Linux ISO image with minimal effort.
This is a fork of [Minimal Linux Script](https://github.com/ivandavidov/minimal-linux-script).
The idea was to add USB 3 support in order to make a small system with DD for backups.
